...
public class BellCurveMaster {
	...
	Properties prop = baseclass.PropertiesConfigurations(".//src//Properties//PMS&Training.BellCurveMaster.properties");
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\PMS and Training\\BellCurveMaster.xls", "Sheet3", 0, 11);
	...
	public void baseLogin() throws BiffException, IOException, InterruptedException, Exception{
		...
		System.out.println("TEST 1 : Login successfully");
			...
			driver.findElement(By.linkText(prop.getProperty("bellcurve_id"))).click();
...
//---------------> ADD NEW DATA USING DATA PROVIDER ---------------->	
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("percentagecount_id"))));
	driver.findElement(By.id(prop.getProperty("percentagecount_id"))).sendKeys(percent);
	...
	try{
		if(driver.findElement(By.id(prop.getProperty("percentagecount_id"))).isDisplayed()){
	...
	System.out.println("TEST 6 :duplicate data or missing data : cancel add new process for this data");
		...
		public Object[][] readExcel() throws BiffException, IOException{
			...
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\PMS and Training\\BellCurveMaster.xls");
