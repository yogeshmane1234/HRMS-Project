...
public class RatingFormulaMaster {
	...
	Properties prop = baseclass.PropertiesConfigurations(".//src//Properties//PMS&Training.RatingFormulaMaster.properties");
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\PMS and Training\\RatingFormula.xls", "Sheet3", 0, 11);
	...
	public void baseLogin() throws BiffException, IOException, InterruptedException, Exception{
		...
		System.out.println("TEST 1 : Login successfully");
			...
			driver.findElement(By.linkText(prop.getProperty("ratingformula_linktext"))).click();
	...
	@Test(priority=1)
	public void ratingSearchButton() throws Exception{
	Thread.sleep(2000);
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
   ...
   // Assert.assertEquals(driver.getTitle(), "Question Master");
    ...
    System.out.println("Functionality of search button is working properly");
	   ...
	   System.out.println("Functionality of search button is working properly");
		...
		@Test(priority=2)
		public void ratingClearButton() throws Exception{
		Thread.sleep(2000);	
		//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		//----------------------> edit functionality ------------------->	 	  
		@Test(priority=3)
		public void ratingEdit() throws Exception{
		Thread.sleep(2000);
			driver.findElement(By.id(prop.getProperty("editbutton_id"))).click();
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			Thread.sleep(2000);
			
			wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("calendar_id"))));
			Select dropdown = new Select(driver.findElement(By.id(prop.getProperty("calendar_id")))); 
			...
			if(driver.findElement(By.id(prop.getProperty("calendar_id"))).isDisplayed())
			{
				 Thread.sleep(2000);
...
//---------------> ADD NEW DATA USING DATA PROVIDER ---------------->	
	...
	@Test(dataProvider = "ratingdata",priority=4)
	public void ratingformulaNewData(String calendar) throws Exception{
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("calendar_id"))));
	Select dropdown = new Select(driver.findElement(By.id(prop.getProperty("calendar_id")))); 
	dropdown.selectByVisibleText(calendar);
	
	if(driver.findElement(By.linkText(prop.getProperty("CompetencyActual_linktext"))).isDisplayed()){
		
		wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("CompetencyActual_linktext"))));
		driver.findElement(By.id(prop.getProperty("CompetencyActual_linktext"))).click();
		
		wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("calculatorvalue1_id"))));
		driver.findElement(By.id(prop.getProperty("calculatorvalue1_id"))).click();
		
		wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("PLUSSIGN_ID"))));
		driver.findElement(By.id(prop.getProperty("PLUSSIGN_ID"))).click();
		
		wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("VALUE2_ID"))));
		driver.findElement(By.id(prop.getProperty("VALUE2_ID"))).click();
		...
		public Object[][] readExcel() throws BiffException, IOException{
			...
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\PMS and Training\\RatingFormula.xls");
