...
public class CompetencyMapping {
	...
	Properties prop = baseclass.PropertiesConfigurations(".//src//Properties//PMS&Training.CompetencyMapping.properties");
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\PMS and Training\\CompetencyMapping.xls", "Sheet3", 0, 11);
	...
	driver.findElement(By.id(prop.getProperty("searchboxbutton_id"))).click();
    ...
    System.out.println("Functionality of search button is working properly");
	   ...
	   System.out.println("Functionality of search button is working properly");
		...
		Thread.sleep(2000);
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("weightage_id"))));
			driver.findElement(By.id(prop.getProperty("weightage_id"))).clear();
			driver.findElement(By.id(prop.getProperty("weightage_id"))).sendKeys(data1[3][2]); 
			...
			if(driver.findElement(By.id(prop.getProperty("weightage_id"))).isDisplayed())
			{
				 Thread.sleep(2000);
...
//---------------> ADD NEW DATA USING DATA PROVIDER ---------------->	
	...
	@Test(dataProvider = "competencydata",priority=4)
	public void competencymappingNewData(String designation, String category, String weightage) throws Exception{
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("designation_id"))));
	Select dropdown = new Select(driver.findElement(By.id(prop.getProperty("designation_id")))); 
	dropdown.selectByVisibleText(designation);
	
	Thread.sleep(2000);
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("addnewaddnew_id"))));
	driver.findElement(By.id(prop.getProperty("addnewaddnew_id"))).click();
	
	Thread.sleep(2000);
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("category_id"))));
	Select dropdown1 = new Select(driver.findElement(By.id(prop.getProperty("category_id")))); 
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("add_id"))));
	driver.findElement(By.id(prop.getProperty("add_id"))).click();
	Thread.sleep(1000);
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("close_id"))));
	driver.findElement(By.id(prop.getProperty("close_id"))).click();
	Thread.sleep(1000);
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("weightage_id"))));
	driver.findElement(By.id(prop.getProperty("weightage_id"))).sendKeys(weightage);
	...
	try{
		...
		driver.getTitle().equalsIgnoreCase("Competency Mapping");	
		...
		@DataProvider(name="competencydata")
		public Object[][] readExcel() throws BiffException, IOException{
			
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\PMS and Training\\CompetencyMapping.xls");
