...
public class SectionConfiguration {
	...
	Properties prop = baseclass.PropertiesConfigurations(".//src//Properties//PMS&Training.SectionConfiguration.properties");
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\PMS and Training\\SectionConfiguration.xls", "Sheet3", 0, 11);
	...
	public void baseLogin() throws BiffException, IOException, InterruptedException, Exception{
		...
		System.out.println("TEST 1 : Login successfully");
			...
			driver.findElement(By.linkText(prop.getProperty("sc_linktext"))).click();
    ...
    System.out.println("Functionality of search button is working properly");
	   ...
	   System.out.println("Functionality of search button is working properly");
		...
		Thread.sleep(2000);
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("viewcomment_id"))));
			driver.findElement(By.id(prop.getProperty("viewcomment_id"))).click();			
			...
			try{
				...
				driver.findElement(By.id(prop.getProperty("heading_id"))).isDisplayed();
				Thread.sleep(2000);
...
//---------------> ADD NEW DATA USING DATA PROVIDER ---------------->	
	...
	public void sectionconfigurationNewData(String type, String name, String heading) throws Exception{
	...
	Thread.sleep(1000);
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("heading_id"))));
	driver.findElement(By.id(prop.getProperty("heading_id"))).sendKeys(heading);
	...
	System.out.println("TEST 6 :duplicate data or missing data : cancel add new process for this data");
		...
		public Object[][] readExcel() throws BiffException, IOException{
			...
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\PMS and Training\\SectionConfiguration.xls");
