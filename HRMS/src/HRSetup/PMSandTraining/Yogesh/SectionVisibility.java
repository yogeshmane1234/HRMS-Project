...
public class SectionVisibility {
	...
	Properties prop = baseclass.PropertiesConfigurations(".//src//Properties//PMS&Training.SectionVisibility.properties");
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\PMS and Training\\SectionVisibility.xls", "Sheet3", 0, 11);
	...
	public void baseLogin() throws BiffException, IOException, InterruptedException, Exception{
		...
		System.out.println("TEST 1 : Login successfully");
			...
			driver.findElement(By.linkText(prop.getProperty("sv_linktext"))).click();
	...
	@Test(priority=1)
	public void sectionSearchButton() throws Exception{
	Thread.sleep(2000);
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
   ...
   // Assert.assertEquals(driver.getTitle(), "Question Master");
    ...
    System.out.println("Functionality of search button is working properly");
	   ...
	   System.out.println("Functionality of search button is working properly");
		...
		@Test(priority=2)
		public void sectionClearButton() throws Exception{
		Thread.sleep(2000);	
		//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		//----------------------> edit functionality ------------------->	 	  
		@Test(priority=3)
		public void sectionEdit() throws Exception{
		Thread.sleep(2000);
			driver.findElement(By.id(prop.getProperty("editbutton_id"))).click();
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			Thread.sleep(2000);
			
			wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("visibilitycheckbox_id"))));
			driver.findElement(By.id(prop.getProperty("visibilitycheckbox_id"))).click();			
			...
			try{
				...
				driver.findElement(By.id(prop.getProperty("visibilitycheckbox_id"))).isDisplayed();
				Thread.sleep(2000);
...
//---------------> ADD NEW DATA USING DATA PROVIDER ---------------->	
	...
	@Test(dataProvider = "sectiondata",priority=4)
	public void sectionconfigurationNewData(String Calendar) throws Exception{
	...
	try{
		if(driver.findElement(By.id(prop.getProperty("visibilitycheckbox_id"))).isDisplayed()){
	...
	System.out.println("TEST 6 :duplicate data or missing data : cancel add new process for this data");
		...
		public Object[][] readExcel() throws BiffException, IOException{
			...
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\PMS and Training\\SectionVisibility.xls");
