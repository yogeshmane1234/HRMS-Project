...
public class ReviewGroup {
	...
	Properties prop = baseclass.PropertiesConfigurations(".//src//Properties//PMS&Training.GroupReview.properties");
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\PMS and Training\\ReviewGroup.xls", "Sheet3", 0, 11);
	...
	public void baseLogin() throws BiffException, IOException, InterruptedException, Exception{
		...
		System.out.println("TEST 1 : Login successfully");
			...
			driver.findElement(By.linkText(prop.getProperty("group_linktext"))).click();
	...
	@Test(priority=1)
	public void groupSearchButton() throws Exception{
	Thread.sleep(2000);
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
   ...
   // Assert.assertEquals(driver.getTitle(), "Question Master");
    ...
    System.out.println("Functionality of search button is working properly");
	   ...
	   System.out.println("Functionality of search button is working properly");
		...
		@Test(priority=2)
		public void groupClearButton() throws Exception{
		Thread.sleep(2000);	
		//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		//----------------------> edit functionality ------------------->	 	  
		@Test(priority=3)
		public void groupEdit() throws Exception{
		Thread.sleep(2000);
			...
			driver.findElement(By.id(prop.getProperty("description_id"))).clear();
			driver.findElement(By.id(prop.getProperty("description_id"))).sendKeys(data1[3][2]); 
			...
			try{
				...
				driver.findElement(By.id(prop.getProperty("description_id"))).isDisplayed();
				Thread.sleep(2000);
...
//---------------> ADD NEW DATA USING DATA PROVIDER ---------------->	
	...
	@Test(dataProvider = "groupdata",priority=4)
	public void reviewgroupNewData(String name, String description) throws Exception{
	...
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("gname_id"))));
	driver.findElement(By.id(prop.getProperty("gname_id"))).sendKeys(name);
	
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("description_id"))));
	driver.findElement(By.id(prop.getProperty("description_id"))).sendKeys(description);
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("ou_id"))));
	driver.findElement(By.id(prop.getProperty("ou_id"))).click();
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("location_id"))));
	driver.findElement(By.id(prop.getProperty("location_id"))).click();
	
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("grade_id"))));
	driver.findElement(By.id(prop.getProperty("grade_id"))).click();
	
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("region_id"))));
	driver.findElement(By.id(prop.getProperty("region_id"))).click();
	
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("city_id"))));
	driver.findElement(By.id(prop.getProperty("city_id"))).click();
	
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("department_id"))));
	driver.findElement(By.id(prop.getProperty("department_id"))).click();
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("savebutton_id"))));
	driver.findElement(By.id(prop.getProperty("savebutton_id"))).click();
	...
	try{
		if(driver.findElement(By.id(prop.getProperty("description_id"))).isDisplayed()){
	...
	System.out.println("TEST 6 :duplicate data or missing data : cancel add new process for this data");
		...
		public Object[][] readExcel() throws BiffException, IOException{
			...
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\PMS and Training\\ReviewGroup.xls");
