...
public class LeaveTypeMaster {
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\Employee Life Cycle\\LeaveTypeMaster.xls", "Sheet3", 0, 11);
	...
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);	
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("LTMdropdownsearch_id"))));
	Select Searchdropdown = new Select(driver.findElement(By.id(prop.getProperty("LTMdropdownsearch_id")))); 
	Searchdropdown.selectByVisibleText(data1[3][0]);
	driver.findElement(By.id(prop.getProperty("LTMsearchbox_id"))).sendKeys(data1[3][1]);	
  
	driver.findElement(By.id(prop.getProperty("LTMSearchbutton_id"))).click();
   // Assert.assertEquals(driver.getTitle(), "Question Master");
	...
	try{
		...
		driver.findElement(By.id(prop.getProperty("LTMSearchbutton_id"))).isSelected();
	...
	//--------------------> clear search button functionality ------------------> 
		...
		driver.findElement(By.id(prop.getProperty("LTMSearchbutton_id"))).click();
		Thread.sleep(1000);
		driver.findElement(By.id(prop.getProperty("LTMclearsearchbutton_id"))).click();
	   // Assert.assertEquals(driver.getTitle(), "Question Master");
		WebElement TxtBoxContent = driver.findElement(By.id(prop.getProperty("LTMsearchbox_id")));
	...
	//----------------------> edit functionality ------------------->	 	  
			...
			baseclass.CommomSection1("HR_id", "HRsetup_linktext", "EmployeeLifeCycle_xpath", "LTMLeaveTypeMaster_linktext", driver);
				driver.findElement(By.id(prop.getProperty("LTMEditbutton_id"))).click();
				driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				Thread.sleep(2000);
				driver.findElement(By.id(prop.getProperty("LTMpayable_id"))).clear();
				driver.findElement(By.id(prop.getProperty("LTMpayable_id"))).sendKeys(data1[3][2]);
	...
	if(driver.findElement(By.id(prop.getProperty("LTMactivecheckbox_id"))).isSelected()){
		...
		public Object[][] readExcel() throws BiffException, IOException{
			...
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\Employee Life Cycle\\LeaveTypeMaster.xls");
