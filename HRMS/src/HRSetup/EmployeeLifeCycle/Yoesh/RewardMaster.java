...
public class RewardMaster {
	...
	Properties prop = baseclass.PropertiesConfigurations(".//src//Properties//EmployeeLifeCycle.RewardMaster.properties");
	...
	String data1[][]=dataXLS.CellData("D:\\HRMS DATA\\Datasheet\\Employee Life Cycle\\RewardMaster.xls", "Sheet3", 0, 11);
	...
	public void baseLogin() throws BiffException, IOException, InterruptedException, Exception{
		...
		System.out.println("TEST 1 : Login successfully");
			...
			WebElement element2 = driver.findElement(By.xpath(prop
					.getProperty("EmployeeLifeCycle_xpath")));
			action.moveToElement(element2).perform();

			Thread.sleep(1000);

			driver.findElement(By.linkText(prop.getProperty("reward_linktext"))).click();
	...
	Thread.sleep(2000);
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewarddropdown_id"))));
	Select dropdown = new Select(driver.findElement(By.id(prop.getProperty("rewarddropdown_id")))); 
	dropdown.selectByVisibleText(data1[3][0]);
	
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewardsearchbox_id"))));
	driver.findElement(By.id(prop.getProperty("rewardsearchbox_id"))).sendKeys(data1[3][1]);	
  
	driver.findElement(By.id(prop.getProperty("rewardsearchbutton_id"))).click();
   // Assert.assertEquals(driver.getTitle(), "Question Master");
    ...
    System.out.println("Functionality of search button is working properly");
	   ...
	   System.out.println("Functionality of search button is working properly");
		...
		dropdown.selectByVisibleText(data1[3][0]);
		wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewardsearchbox_id"))));
		driver.findElement(By.id(prop.getProperty("rewardsearchbox_id"))).clear();
		driver.findElement(By.id(prop.getProperty("rewardsearchbox_id"))).sendKeys(data1[3][1]);	
	  
		//driver.findElement(By.id(prop.getProperty("rewardsearchbutton_id"))).click();
		    
			Thread.sleep(2000);
			driver.findElement(By.id(prop.getProperty("rewardclearbutton_id"))).click();
			Thread.sleep(1000);
			
			WebElement TxtBoxContent = driver.findElement(By.id(prop.getProperty("rewardsearchbox_id")));
		...
		Thread.sleep(2000);
			driver.findElement(By.id(prop.getProperty("rewardeditbutton_id"))).click();
			driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
			Thread.sleep(2000);
			
			wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewardremark_id"))));
			driver.findElement(By.id(prop.getProperty("rewardremark_id"))).clear();
			driver.findElement(By.id(prop.getProperty("rewardremark_id"))).sendKeys(data1[3][2]); 
						
			driver.findElement(By.id(prop.getProperty("rewardokbutton_id"))).click();
			Thread.sleep(2000);
			Alert alert=driver.switchTo().alert();
			...
			if(driver.findElement(By.id(prop.getProperty("rewardremark_id"))).isDisplayed())
			{
				 Thread.sleep(2000);
				driver.findElement(By.id(prop.getProperty("rewardcancelbutton_id"))).click();
...
//---------------> ADD NEW DATA USING DATA PROVIDER ---------------->	
	...
	@Test(dataProvider = "Rewarddata",priority=4)
	public void RewardMasterNewData(String category, String amount, String remark) throws Exception{
		//System.setProperty("webdriver.chrome.driver",""));
	//baseclass.CommomSection1("HR_id", "HRsetup_linktext", "EmployeeLifeCycle_xpath", "stm_linktext", driver);
	
	driver.findElement(By.id(prop.getProperty("rewardaddnew_id"))).click();
	Thread.sleep(1000);
				
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewardcategory_id"))));
	driver.findElement(By.id(prop.getProperty("rewardcategory_id"))).sendKeys(category);
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewardamount_id"))));
	driver.findElement(By.id(prop.getProperty("rewardamount_id"))).sendKeys(amount);
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewardremark_id"))));
	driver.findElement(By.id(prop.getProperty("rewardremark_id"))).sendKeys(remark);
		
	wait.until(ExpectedConditions.elementToBeClickable(By.id(prop.getProperty("rewardokbutton_id"))));
	driver.findElement(By.id(prop.getProperty("rewardokbutton_id"))).click();
	...
	System.out.println("TEST 6 :duplicate data or missing data : cancel add new process for this data");
		...
		@DataProvider(name="Rewarddata")
		public Object[][] readExcel() throws BiffException, IOException{
			
			FileInputStream abc = new FileInputStream("D:\\HRMS DATA\\Datasheet\\Employee Life Cycle\\RewardMaster.xls");
